...
<?php if (have_posts()) : ?>
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<h2><a href="javascript:parent.afficherPanneau( 'element', <?php the_ID() ?>);" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
		<p class="meta"><span><?php echo get_field('abrege'); ?></span></p>
		<p class="meta"><span><?php echo fabriqueLegende($get_the_ID); ?></span></p>
